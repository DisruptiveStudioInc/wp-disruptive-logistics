<?php
namespace CargoTruckingSpace\Kits\Settings\FooterWidgets;
...
class Footer_Widgets extends Settings_Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'Footer Widgets', 'cargo-trucking' );
	}
	...
	protected function register_toggle_controls() {
		$this->add_control(
			'notice',
			array(
				'raw' => esc_html__( "If you use a 'Footer' template, then the settings will not be applied, if you set the template to sitewide, then these settings will be hidden.", 'cargo-trucking' ),
		...
		$this->add_control(
			...
			array(
				...
				'options' => array(
					'show' => esc_html__( 'Show On All Devices', 'cargo-trucking' ),
					'hide_tablet' => esc_html__( 'Hide On Tablet And Less', 'cargo-trucking' ),
					'hide_mobile' => esc_html__( 'Hide On Mobile', 'cargo-trucking' ),
					'hide' => esc_html__( 'Hide On All Devices', 'cargo-trucking' ),
				),
		...
		$this->start_controls_tab(
			...
			array(
				'label' => esc_html__( 'Desktop', 'cargo-trucking' ),
			)
		);
		...
		$this->add_control(
			...
			array(
				'label_block' => true,
				'show_label' => false,
				'raw' => esc_html__( 'Layout for this columns count will be', 'cargo-trucking' ) . '<br />1/5 + 1/5 + 1/5 + 1/5 + 1/5',
				'type' => Controls_Manager::RAW_HTML,
		...
		$this->start_controls_tab(
			...
			array(
				'label' => esc_html__( 'Tablet', 'cargo-trucking' ),
			)
		);
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Columns in Row', 'cargo-trucking' ),
				'label_block' => true,
				'description' => esc_html__( 'This setting will be applied after save and reload.', 'cargo-trucking' ),
				'type' => CmsmastersControls::CHOOSE_TEXT,
				'options' => array(
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Reverse Columns', 'cargo-trucking' ),
				'description' => esc_html__( 'This setting will be applied after save and reload.', 'cargo-trucking' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => esc_html__( 'No', 'cargo-trucking' ),
				'label_on' => esc_html__( 'Yes', 'cargo-trucking' ),
				'default' => $this->get_default_setting(
		...
		$this->add_control(
			'tablet_hide_1',
			array(
				'label' => esc_html__( 'Hide "Footer 1" widgets area', 'cargo-trucking' ),
				'description' => esc_html__( 'This setting will be applied after save and reload.', 'cargo-trucking' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => esc_html__( 'No', 'cargo-trucking' ),
				'label_on' => esc_html__( 'Yes', 'cargo-trucking' ),
		...
		$this->add_control(
			'tablet_hide_2',
			array(
				'label' => esc_html__( 'Hide "Footer 2" widgets area', 'cargo-trucking' ),
				'description' => esc_html__( 'This setting will be applied after save and reload.', 'cargo-trucking' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => esc_html__( 'No', 'cargo-trucking' ),
				'label_on' => esc_html__( 'Yes', 'cargo-trucking' ),
		...
		$this->add_control(
			'tablet_hide_3',
			array(
				'label' => esc_html__( 'Hide "Footer 3" widgets area', 'cargo-trucking' ),
				'description' => esc_html__( 'This setting will be applied after save and reload.', 'cargo-trucking' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => esc_html__( 'No', 'cargo-trucking' ),
				'label_on' => esc_html__( 'Yes', 'cargo-trucking' ),
		...
		$this->add_control(
			'tablet_hide_4',
			array(
				'label' => esc_html__( 'Hide "Footer 4" widgets area', 'cargo-trucking' ),
				'description' => esc_html__( 'This setting will be applied after save and reload.', 'cargo-trucking' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => esc_html__( 'No', 'cargo-trucking' ),
				'label_on' => esc_html__( 'Yes', 'cargo-trucking' ),
		...
		$this->add_control(
			'tablet_hide_5',
			array(
				'label' => esc_html__( 'Hide "Footer 5" widgets area', 'cargo-trucking' ),
				'description' => esc_html__( 'This setting will be applied after save and reload.', 'cargo-trucking' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => esc_html__( 'No', 'cargo-trucking' ),
				'label_on' => esc_html__( 'Yes', 'cargo-trucking' ),
		...
		$this->start_controls_tab(
			...
			array(
				'label' => esc_html__( 'Mobile', 'cargo-trucking' ),
			)
		);
		...
		$this->add_responsive_control(
			'columns_gap',
			array(
				'label' => esc_html__( 'Columns Gap', 'cargo-trucking' ),
		...
		$this->add_responsive_control(
			'widgets_gap',
			array(
				'label' => esc_html__( 'Widgets Gap Between', 'cargo-trucking' ),
				'type' => Controls_Manager::SLIDER,
				'range' => array(
					'px' => array(
						'min' => 0,
