...
class More_Posts extends Settings_Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'More Posts', 'cargo-trucking' );
	}
	...
	protected function register_toggle_controls() {
		$this->add_control(
			...
			array(
				...
				'placeholder' => esc_html__( 'More Posts', 'cargo-trucking' ),
			)
		);
		...
		$this->add_control(
			...
			array(
				'raw' => esc_html__( 'This setting will be applied after save and reload', 'cargo-trucking' ),
		...
		$this->add_control(
			'more_posts_order',
			array(
				'label' => esc_html__( 'Order by', 'cargo-trucking' ),
				'label_block' => false,
				'description' => esc_html__( 'This setting will be applied after save and reload.', 'cargo-trucking' ),
				'type' => Controls_Manager::SELECT,
				'options' => array(
					'recent' => esc_html__( 'Recent', 'cargo-trucking' ),
					'category' => esc_html__( 'Related by Categories', 'cargo-trucking' ),
					'post_tag' => esc_html__( 'Related by Tags', 'cargo-trucking' ),
				),
				'default' => $this->get_default_setting(
		...
		$this->add_control(
			'more_posts_count',
			array(
				'label' => esc_html__( 'Count', 'cargo-trucking' ),
				'description' => esc_html__( 'This setting will be applied after save and reload.', 'cargo-trucking' ),
