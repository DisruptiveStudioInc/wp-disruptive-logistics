...
class Comments extends Settings_Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'Comments', 'cargo-trucking' );
	}
	...
	protected function register_toggle_controls() {
		$this->add_responsive_control(
			'items_vert_gap',
			array(
				'label' => esc_html__( 'Items Vertical Gap Between', 'cargo-trucking' ),
		...
		$this->add_responsive_control(
			'items_hor_gap',
			array(
				'label' => esc_html__( 'Child Items Horizontal Gap', 'cargo-trucking' ),
				'type' => Controls_Manager::SLIDER,
				'range' => array(
					'px' => array(
						'min' => 0,
