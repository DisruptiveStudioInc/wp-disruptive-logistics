...
class Nav extends Settings_Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'Posts Navigation', 'cargo-trucking' );
	}
	...
	protected function register_toggle_controls() {
		$this->add_control(
			'nav_tax',
			array(
				'label' => esc_html__( 'Order by Taxonomy', 'cargo-trucking' ),
				'label_block' => false,
				...
				'options' => array(
					...
					'category' => esc_html__( 'Category', 'cargo-trucking' ),
					'post_tag' => esc_html__( 'Tag', 'cargo-trucking' ),
				),
		...
		$this->add_control(
			'nav_text_above_prev',
			array(
				'label' => esc_html__( 'Text Above Previous Post Title', 'cargo-trucking' ),
				'label_block' => true,
				'description' => esc_html__( 'This setting will be applied after save and reload.', 'cargo-trucking' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => esc_html__( 'Previous', 'cargo-trucking' ),
			)
		);
		...
		$this->add_control(
			'nav_text_above_next',
			array(
				'label' => esc_html__( 'Text Above Next Post Title', 'cargo-trucking' ),
				'label_block' => true,
				'description' => esc_html__( 'This setting will be applied after save and reload.', 'cargo-trucking' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => esc_html__( 'Next', 'cargo-trucking' ),
			)
		);
