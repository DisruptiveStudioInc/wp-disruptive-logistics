<?php
namespace CargoTruckingSpace\Kits\Settings\Footer;
...
class Footer extends Settings_Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'Footer', 'cargo-trucking' );
	}
	...
	protected function register_toggle_controls() {
		...
		$this->add_control(
			'alignment',
			array(
				'label' => esc_html__( 'Alignment', 'cargo-trucking' ),
				'label_block' => false,
				'type' => Controls_Manager::CHOOSE,
				'options' => array(
					'center' => array(
					...
					'space-between' => array(
						'title' => esc_html__( 'Justified', 'cargo-trucking' ),
		...
		$this->add_control(
			...
			array(
				...
				'options' => array(
					'copyright' => esc_html__( 'Copyright', 'cargo-trucking' ),
					...
					'logo' => esc_html__( 'Logo', 'cargo-trucking' ),
