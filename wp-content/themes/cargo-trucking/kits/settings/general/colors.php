...
class Colors extends Settings_Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'Colors', 'cargo-trucking' );
	}
	...
	protected function register_toggle_controls() {
		...
		$this->add_control(
			'heading',
			array(
				'label' => esc_html__( 'Heading', 'cargo-trucking' ),
				'type' => Controls_Manager::COLOR,
				'dynamic' => array(),
				'selectors' => array(
		...
		$this->add_control(
			'bg',
			array(
				'label' => esc_html__( 'Main Background', 'cargo-trucking' ),
				'type' => Controls_Manager::COLOR,
				'dynamic' => array(),
				'selectors' => array(
					':root' => "--{$key}-bg: {{VALUE}};",
		...
		$this->add_control(
			'alternate',
			array(
				'label' => esc_html__( 'Alternate Background', 'cargo-trucking' ),
				'type' => Controls_Manager::COLOR,
				'dynamic' => array(),
				'selectors' => array(
