...
class Table extends Settings_Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'Table', 'cargo-trucking' );
	}
	...
	protected function register_toggle_controls() {
		$this->add_control(
			'notice',
			array(
				'raw' => esc_html__( 'Used in: default table, Gutenberg editor.', 'cargo-trucking' ),
		...
		$parts = array(
			'tbody' => '',
			'thead' => esc_html__( 'Header', 'cargo-trucking' ),
			'tfoot' => esc_html__( 'Footer', 'cargo-trucking' ),
		);
