...
class Caption extends Settings_Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'Caption', 'cargo-trucking' );
	}
	...
	protected function register_toggle_controls() {
		$this->add_control(
			'notice',
			array(
				'raw' => esc_html__( 'Used in: default caption, Gutenberg editor.', 'cargo-trucking' ),
		...
		foreach ( array(
			'outside' => esc_html__( 'Outside', 'cargo-trucking' ),
			'inside' => esc_html__( 'Inside', 'cargo-trucking' ),
		) as $key => $label ) {
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Image with Caption', 'cargo-trucking' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);
		...
		$this->add_control(
			'image_notice',
			array(
				'raw' => esc_html__( 'Used for classic wp-caption image.', 'cargo-trucking' ),
				'type' => Controls_Manager::RAW_HTML,
