<?php
namespace CargoTruckingSpace\Kits\Settings\Main;
...
class Main extends Settings_Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'Main', 'cargo-trucking' );
	}
	...
	protected function register_toggle_controls() {
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Content', 'cargo-trucking' ),
		...
		$this->add_responsive_control(
			...
			array(
				...
				'description' => esc_html__( 'This value will be used for page layouts with sidebar.', 'cargo-trucking' ) . '<br />' . esc_html__( 'The width of the sidebar will be equal "100% - this value".', 'cargo-trucking' ) . '<br />' . esc_html__( 'For example: 74% - content width, then sidebar width will be 26%.', 'cargo-trucking' ) . '<br />' . esc_html__( 'Default value is 74%.', 'cargo-trucking' ),
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Sidebar', 'cargo-trucking' ),
				'type' => Controls_Manager::HEADING,
			)
		);
		...
		$this->add_responsive_control(
			'sidebar_gap',
			array(
				'label' => esc_html__( 'Gap', 'cargo-trucking' ),
				'description' => esc_html__( 'Gap between content and sidebar.', 'cargo-trucking' ) . '<br />' . esc_html__( 'Default value is 40px.', 'cargo-trucking' ) . '<br />' . esc_html__( 'Note: This gap reduces the width of the sidebar.', 'cargo-trucking' ),
				'type' => Controls_Manager::SLIDER,
				'range' => array(
					'px' => array(
						'min' => 0,
		...
		$this->add_control(
			...
			array(
				'label' => _x( 'Divider Type', 'Divider Control', 'cargo-trucking' ),
				'type' => Controls_Manager::SELECT,
				'options' => array(
					'' => _x( 'Default', 'Divider Control', 'cargo-trucking' ),
					'none' => _x( 'None', 'Divider Control', 'cargo-trucking' ),
					'solid' => _x( 'Solid', 'Divider Control', 'cargo-trucking' ),
					'double' => _x( 'Double', 'Divider Control', 'cargo-trucking' ),
					'dotted' => _x( 'Dotted', 'Divider Control', 'cargo-trucking' ),
					'dashed' => _x( 'Dashed', 'Divider Control', 'cargo-trucking' ),
					'groove' => _x( 'Groove', 'Divider Control', 'cargo-trucking' ),
				),
				'selectors' => array(
		...
		$this->add_responsive_control(
			...
			array(
				'label' => _x( 'Width', 'Divider Control', 'cargo-trucking' ),
				'type' => Controls_Manager::SLIDER,
				'range' => array(
					'px' => array(
						'min' => 0,
		...
		$this->add_control(
			...
			array(
				'label' => _x( 'Color', 'Divider Control', 'cargo-trucking' ),
