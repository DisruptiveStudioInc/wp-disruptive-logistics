<?php
namespace CargoTruckingSpace\Kits\Settings\HeaderMid;
...
class Header_Mid extends Settings_Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'Header Middle', 'cargo-trucking' );
	}
	...
	protected function register_toggle_controls() {
		$this->add_control(
			'notice',
			array(
				'raw' => esc_html__( "If you use a 'Header' template, then the settings will not be applied, if you set the template to sitewide, then these settings will be hidden.", 'cargo-trucking' ),
		...
		$this->add_control(
			...
			array(
				...
				'options' => array(
					'wide' => array(
						'title' => esc_html__( 'Wide', 'cargo-trucking' ),
					),
					'centered' => array(
						'title' => esc_html__( 'Centered', 'cargo-trucking' ),
					),
				),
		...
		$this->add_control(
			'height',
			array(
				'label' => esc_html__( 'Height', 'cargo-trucking' ),
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Content Element', 'cargo-trucking' ),
		...
		$this->add_control(
			...
			array(
				...
				'options' => array(
					...
					'info' => esc_html__( 'Short Info', 'cargo-trucking' ),
					'html' => esc_html__( 'Custom HTML', 'cargo-trucking' ),
					'nav' => esc_html__( 'Navigation', 'cargo-trucking' ),
				),
				'default' => $this->get_default_setting(
		...
		$this->add_responsive_control(
			...
			array(
				...
				'description' => esc_html__( 'Gap between content and additional content', 'cargo-trucking' ),
				'type' => Controls_Manager::SLIDER,
				'range' => array(
					'px' => array(
						'min' => -10,
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Additional Content Elements Order', 'cargo-trucking' ),
				'type' => Controls_Manager::HEADING,
				'condition' => array(
					$this->get_control_id_parameter( '', 'type' ) => 'wide',
				),
		...
		$this->add_control(
			...
			array(
				...
				'options' => array(
					'social' => esc_html__( 'Social Icons', 'cargo-trucking' ),
					'button' => esc_html__( 'Button', 'cargo-trucking' ),
					'search_button' => esc_html__( 'Search Button', 'cargo-trucking' ),
				),
				'multiple' => true,
				'default' => $this->get_default_setting(
		...
		$this->add_responsive_control(
			...
			array(
				'label' => esc_html__( 'Gap Between', 'cargo-trucking' ),
				'description' => esc_html__( 'Gap between additional content items', 'cargo-trucking' ),
				'type' => Controls_Manager::SLIDER,
				'range' => array(
					'px' => array(
						'min' => -10,
		...
		$this->add_responsive_control(
			'z_index',
			array(
				'label' => esc_html__( 'Z-Index', 'cargo-trucking' ),
