<?php
namespace CargoTruckingSpace\Kits\Settings\LazyloadWidget;
...
class Preloader extends Settings_Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'Preloader', 'cargo-trucking' );
	}
	...
	protected function register_toggle_controls() {
		...
		$this->add_control(
			'icon_color',
			array(
				'label' => esc_html__( 'Icon Color', 'cargo-trucking' ),
		...
		$this->add_control(
			'icon_animation_type',
			array(
				'label' => __( 'Icon Animation Type', 'cargo-trucking' ),
				'label_block' => false,
				'type' => Controls_Manager::SELECT,
				'options' => array(
					'none' => __( 'None', 'cargo-trucking' ),
					'lazyLoadWidgetBlink' => __( 'Blink', 'cargo-trucking' ),
					'lazyLoadWidgetSpinner' => __( 'Spin', 'cargo-trucking' ),
				),
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Icon Animation Speed', 'cargo-trucking' ) . ' (ms)',
		...
		$this->add_responsive_control(
			'height',
			array(
				'label' => __( 'Height', 'cargo-trucking' ),
				'type' => Controls_Manager::SLIDER,
		...
		$this->add_var_group_control( 'overlay', self::VAR_BACKGROUND, array(
			'fields_options' => array(
				'background' => array(
					'label' => esc_html_x( 'Overlay Background Type', 'Background Control', 'cargo-trucking' ),
				),
			),
			'separator' => 'before',
		) );
		...
		$this->add_var_group_control( '', self::VAR_BORDER, array(
			'fields_options' => array(
				...
				'color' => array(
					'label' => esc_html__( 'Border Color', 'cargo-trucking' ),
					'condition' => array(
						'border!' => array(
							'',
							'none',
