<?php
namespace CargoTruckingSpace\Kits\Settings\Elements;
...
class Slider_Arrows extends Settings_Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'Slider Arrows', 'cargo-trucking' );
	}
	...
	protected function register_toggle_controls() {
		$this->add_control(
			'notice',
			array(
				'raw' => esc_html__( 'Used in: more posts, single post gallery, archive post gallery.', 'cargo-trucking' ),
		...
		$this->add_control(
			...
			array(
				...
				'options' => array(
					'always' => esc_html__( 'Always', 'cargo-trucking' ),
					'hover' => esc_html__( 'On Hover', 'cargo-trucking' ),
				),
				'toggle' => false,
		...
		foreach ( array(
			'prev' => esc_html__( 'Previous', 'cargo-trucking' ),
			'next' => esc_html__( 'Next', 'cargo-trucking' ),
		) as $key => $label ) {
			$is_prev = 'prev' === $key;
			...
			$this->add_control(
				"{$key}_icon_position",
				array(
					'label' => esc_html__( 'Icon Position', 'cargo-trucking' ),
					'description' => esc_html__( 'This setting will be applied after save and reload.', 'cargo-trucking' ),
					'type' => Controls_Manager::SELECT,
					'options' => array(
						'before' => esc_html__( 'Before', 'cargo-trucking' ),
						'after' => esc_html__( 'After', 'cargo-trucking' ),
					),
					'default' => $this->get_default_setting(
		...
		$this->add_control(
			'text_direction',
			array(
				'label' => esc_html__( 'Text Direction', 'cargo-trucking' ),
				'description' => esc_html__( 'This setting will be applied after save and reload.', 'cargo-trucking' ),
				'type' => Controls_Manager::SELECT,
				'options' => array(
					'horizontal' => esc_html__( 'Horizontal', 'cargo-trucking' ),
					'vertical' => esc_html__( 'Vertical', 'cargo-trucking' ),
				),
				'default' => $this->get_default_setting(
		...
		foreach ( array(
			'normal' => esc_html__( 'Normal', 'cargo-trucking' ),
			'hover' => esc_html__( 'Hover', 'cargo-trucking' ),
		) as $key => $label ) {
			$this->start_controls_tab(
				"states_{$key}_tab",
				array( 'label' => $label )
		...
		$this->add_responsive_control(
			'icon_size',
			array(
				'label' => esc_html__( 'Icon Size', 'cargo-trucking' ),
				'type' => Controls_Manager::SLIDER,
		...
		$this->add_responsive_control(
			'spacing',
			array(
				'label' => esc_html__( 'Arrows Spacing', 'cargo-trucking' ),
				'type' => Controls_Manager::SLIDER,
				'range' => array(
					'px' => array(
						'min' => 0,
		...
		$this->add_responsive_control(
			'box_width',
			array(
				'label' => esc_html__( 'Arrows Box Width', 'cargo-trucking' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => array( 'px', '%' ),
				'range' => array(
					'%' => array(
		...
		$this->add_responsive_control(
			'box_height',
			array(
				'label' => esc_html__( 'Arrows Box Height', 'cargo-trucking' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => array( 'px', '%' ),
				'range' => array(
					'%' => array(
		...
		$this->add_responsive_control(
			'icon_gap',
			array(
				'label' => esc_html__( 'Icon Gap', 'cargo-trucking' ),
				'description' => esc_html__( 'Gap Between Icon and Text', 'cargo-trucking' ),
				'type' => Controls_Manager::SLIDER,
				'range' => array(
					'px' => array(
						'max' => 50,
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Text On Tablet/Mobile', 'cargo-trucking' ),
				'label_block' => false,
				'type' => CmsmastersControls::CHOOSE_TEXT,
				'options' => array(
					'flex' => array(
						'title' => esc_html__( 'Show', 'cargo-trucking' ),
					),
					'none' => array(
						'title' => esc_html__( 'Hide', 'cargo-trucking' ),
					),
				),
				'toggle' => true,
				'selectors' => array(
		...
		$this->add_responsive_control(
			...
			array(
				'label' => esc_html__( 'Container', 'cargo-trucking' ),
		...
		$this->add_control(
			...
			array(
				...
				'options' => array(
					'row' => array(
						'title' => esc_html__( 'Horizontal', 'cargo-trucking' ),
						'icon' => 'eicon-navigation-horizontal',
					),
					'column' => array(
						'title' => esc_html__( 'Vertical', 'cargo-trucking' ),
		...
		$this->add_responsive_control(
			...
			array(
				...
				'options' => array(
					...
					'space-between' => array(
						'title' => esc_html__( 'Space Between', 'cargo-trucking' ),
		...
		$this->add_responsive_control(
			...
			array(
				...
				'options' => array(
					...
					'center' => array(
						'title' => esc_html__( 'Middle', 'cargo-trucking' ),
		...
		$this->add_responsive_control(
			'container_margin',
			array(
				'label' => esc_html__( 'Margin', 'cargo-trucking' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => array( 'px' ),
				'selectors' => array(
