...
class Slider_Progressbar extends Settings_Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'Slider Progressbar', 'cargo-trucking' );
	}
	...
	protected function register_toggle_controls() {
		...
		$this->add_control(
			'normal_bg',
			array(
				'label' => esc_html__( 'Normal Background', 'cargo-trucking' ),
		...
		$this->add_control(
			'fill_bg',
			array(
				'label' => esc_html__( 'Fill Background', 'cargo-trucking' ),
				'type' => Controls_Manager::COLOR,
				'dynamic' => array(),
				'selectors' => array(
		...
		$this->add_responsive_control(
			'thickness',
			array(
				'label' => esc_html__( 'Thickness', 'cargo-trucking' ),
		...
		$this->add_responsive_control(
			...
			array(
				...
				'options' => array(
					...
					'flex-start' => esc_html__( 'Start', 'cargo-trucking' ),
					'flex-end' => esc_html__( 'End', 'cargo-trucking' ),
				),
				'selectors' => array(
