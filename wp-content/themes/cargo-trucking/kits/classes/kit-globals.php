<?php
namespace CargoTruckingSpace\Kits\Classes;

use CargoTruckingSpace\Kits\Documents\Kit;
...
class Kit_Globals {
	...
	public static function get_global_colors_defaults() {
		return array(
			array(
				'_id' => 'primary',
				'title' => esc_html__( 'Primary', 'cargo-trucking' ),
				'color' => Theme_Config::PRIMARY_COLOR_DEFAULT,
			),
			array(
				'_id' => 'secondary',
				'title' => esc_html__( 'Secondary', 'cargo-trucking' ),
				'color' => Theme_Config::SECONDARY_COLOR_DEFAULT,
			),
			array(
				'_id' => 'text',
				'title' => esc_html__( 'Text', 'cargo-trucking' ),
				'color' => Theme_Config::TEXT_COLOR_DEFAULT,
			),
			array(
				'_id' => 'accent',
				'title' => esc_html__( 'Accent', 'cargo-trucking' ),
				'color' => Theme_Config::ACCENT_COLOR_DEFAULT,
			),
			array(
				'_id' => 'tertiary',
				'title' => esc_html__( 'Alternate Accent', 'cargo-trucking' ),
				'color' => Theme_Config::TERTIARY_COLOR_DEFAULT,
			),
			array(
				'_id' => 'background',
				'title' => esc_html__( 'Background', 'cargo-trucking' ),
				'color' => Theme_Config::BACKGROUND_COLOR_DEFAULT,
			),
			array(
				'_id' => 'alternate',
				'title' => esc_html__( 'Alternate Background', 'cargo-trucking' ),
				'color' => Theme_Config::ALTERNATE_COLOR_DEFAULT,
			),
			array(
				'_id' => 'border',
				'title' => esc_html__( 'Border', 'cargo-trucking' ),
	...
	public static function get_global_typography_defaults() {
		...
		return array(
			...
			array(
				'_id' => 'meta',
				'title' => esc_html__( 'Meta', 'cargo-trucking' ),
				$typography_key => 'custom',
			...
			array(
				'_id' => 'taxonomy',
				'title' => esc_html__( 'Alternate Meta', 'cargo-trucking' ),
				$typography_key => 'custom',
			...
			array(
				'_id' => 'small',
				'title' => esc_html__( 'Small', 'cargo-trucking' ),
				$typography_key => 'custom',
			...
			array(
				'_id' => 'h1',
				'title' => esc_html__( 'H1', 'cargo-trucking' ),
				$typography_key => 'custom',
			...
			array(
				'_id' => 'h2',
				'title' => esc_html__( 'H2', 'cargo-trucking' ),
				$typography_key => 'custom',
			...
			array(
				'_id' => 'h3',
				'title' => esc_html__( 'H3', 'cargo-trucking' ),
				$typography_key => 'custom',
			...
			array(
				'_id' => 'h4',
				'title' => esc_html__( 'H4', 'cargo-trucking' ),
				$typography_key => 'custom',
			...
			array(
				'_id' => 'h5',
				'title' => esc_html__( 'H5', 'cargo-trucking' ),
				$typography_key => 'custom',
			...
			array(
				'_id' => 'h6',
				'title' => esc_html__( 'H6', 'cargo-trucking' ),
				$typography_key => 'custom',
			...
			array(
				'_id' => 'button',
				'title' => esc_html__( 'Button', 'cargo-trucking' ),
				$typography_key => 'custom',
			...
			array(
				'_id' => 'blockquote',
				'title' => esc_html__( 'Blockquote', 'cargo-trucking' ),
				$typography_key => 'custom',
