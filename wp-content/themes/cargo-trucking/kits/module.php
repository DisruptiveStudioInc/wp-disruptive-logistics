<?php
namespace CargoTruckingSpace\Kits;

use CargoTruckingSpace\Kits\Classes;
use CargoTruckingSpace\Kits\Controls\Controls_Manager;
...
class Module extends ElementorBaseModule {
	...
	public function enqueue_scripts() {
		if ( ! class_exists( 'Cmsmasters_Elementor_Addon' ) ) {
			...
			wp_enqueue_script(
				'cargo-trucking-elementor-kits-controls',
