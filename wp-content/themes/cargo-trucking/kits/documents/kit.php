<?php
namespace CargoTruckingSpace\Kits\Documents;

use CargoTruckingSpace\Kits\Module as KitsModule;
use CargoTruckingSpace\Kits\Settings\Base\Base_Section;
...
class Kit extends BaseKit {
	...
	public function localize_settings( $settings ) {
		$settings = array_replace_recursive( $settings, array(
			'i18n' => array(
				'cmsmasters_theme' => esc_html__( 'Theme Settings', 'cargo-trucking' ),
				'design_system' => esc_html__( 'Design System', 'cargo-trucking' ),
				'theme_style' => esc_html__( 'Theme Style', 'cargo-trucking' ),
				'settings' => esc_html__( 'Settings', 'cargo-trucking' ),
				'additional_settings' => esc_html__( 'Additional Settings', 'cargo-trucking' ),
			),
		) );
