		...
		if ( $heading ) {
			$this->add_control(
				...
				array_merge_recursive(
					$default_args,
					array(
						'label' => esc_html__( 'States', 'cargo-trucking' ),
		...
		foreach ( $states as $state_key => $state_label ) {
			...
			if ( 'gradient' === $background ) {
				$this->add_control(
					...
					array(
						'label' => _x( 'Background Type', 'Background Control', 'cargo-trucking' ),
						'type' => Controls_Manager::CHOOSE,
						'options' => array(
							'classic' => array(
								'title' => _x( 'Classic', 'Background Control', 'cargo-trucking' ),
								'icon' => 'eicon-paint-brush',
							),
							'gradient' => array(
								'title' => _x( 'Gradient', 'Background Control', 'cargo-trucking' ),
								'icon' => 'eicon-barcode',
							),
						),
						'default' => 'classic',
				...
				$this->add_control(
					...
					array(
						'label' => _x( 'Background', 'Background Control', 'cargo-trucking' ),
				...
				$this->add_control(
					...
					array(
						'label' => _x( 'Background Location', 'Background Control', 'cargo-trucking' ),
				...
				$this->add_control(
					...
					array(
						'label' => _x( 'Second Background', 'Background Control', 'cargo-trucking' ),
						'type' => Controls_Manager::COLOR,
						'dynamic' => array(),
						'render_type' => 'ui',
						'condition' => array(
				...
				$this->add_control(
					...
					array(
						'label' => _x( 'Second Background Location', 'Background Control', 'cargo-trucking' ),
						'type' => Controls_Manager::SLIDER,
						'size_units' => array( '%' ),
						'default' => array(
							'unit' => '%',
				...
				$this->add_control(
					...
					array(
						'label' => _x( 'Gradient Type', 'Background Control', 'cargo-trucking' ),
						'type' => Controls_Manager::SELECT,
						'options' => array(
							'linear' => _x( 'Linear', 'Background Control', 'cargo-trucking' ),
							'radial' => _x( 'Radial', 'Background Control', 'cargo-trucking' ),
						),
						'default' => 'linear',
						'render_type' => 'ui',
						'condition' => array(
				...
				$this->add_control(
					...
					array(
						'label' => _x( 'Gradient Angle', 'Background Control', 'cargo-trucking' ),
						'type' => Controls_Manager::SLIDER,
				...
				$this->add_control(
					...
					array(
						'label' => _x( 'Gradient Position', 'Background Control', 'cargo-trucking' ),
						'type' => Controls_Manager::SELECT,
						'options' => array(
							'center center' => _x( 'Center Center', 'Background Control', 'cargo-trucking' ),
							'center left' => _x( 'Center Left', 'Background Control', 'cargo-trucking' ),
							'center right' => _x( 'Center Right', 'Background Control', 'cargo-trucking' ),
							'top center' => _x( 'Top Center', 'Background Control', 'cargo-trucking' ),
							'top left' => _x( 'Top Left', 'Background Control', 'cargo-trucking' ),
							'top right' => _x( 'Top Right', 'Background Control', 'cargo-trucking' ),
							'bottom center' => _x( 'Bottom Center', 'Background Control', 'cargo-trucking' ),
							'bottom left' => _x( 'Bottom Left', 'Background Control', 'cargo-trucking' ),
							'bottom right' => _x( 'Bottom Right', 'Background Control', 'cargo-trucking' ),
						),
			...
			if (
				...
				$this->add_control(
					...
					array(
						'label' => esc_html__( 'Text Decoration', 'cargo-trucking' ),
						'type' => Controls_Manager::SELECT,
						'options' => array(
							'' => esc_html__( 'Default', 'cargo-trucking' ),
							'none' => _x( 'None', 'Typography Control', 'cargo-trucking' ),
							'underline' => _x( 'Underline', 'Typography Control', 'cargo-trucking' ),
							'overline' => _x( 'Overline', 'Typography Control', 'cargo-trucking' ),
							'line-through' => _x( 'Line Through', 'Typography Control', 'cargo-trucking' ),
						),
						'selectors' => array(
			...
			$this->add_var_group_control(
				...
				array(
					'fields_options' => array(
						'width' => array( 'label' => esc_html__( 'Border Width', 'cargo-trucking' ) ),
					),
					'exclude' => array( 'color' ),
					'separator' => 'before',
				)
