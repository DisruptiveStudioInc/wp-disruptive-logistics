	...
	protected function controls_group_slider( $key = '', $args = array() ) {
		...
		if ( $columns_available ) {
			$this->add_responsive_control(
				...
				array_merge_recursive(
					$default_args,
					array(
						'label' => esc_html__( 'Slides Per View', 'cargo-trucking' ),
			...
			$this->add_responsive_control(
				...
				array_merge_recursive(
					$default_args,
					array(
						'label' => esc_html__( 'Slides to Scroll', 'cargo-trucking' ),
						'description' => esc_html__( 'Set how many slides are scrolled per swipe.', 'cargo-trucking' ) . '<br />' . esc_html__( 'This setting will be applied after save and reload.', 'cargo-trucking' ),
						'type' => Controls_Manager::NUMBER,
						'min' => 1,
						'max' => 5,
						'step' => 1,
			...
			$this->add_responsive_control(
				...
				array_merge_recursive(
					$default_args,
					array(
						'label' => esc_html__( 'Space Between', 'cargo-trucking' ),
						'description' => esc_html__( 'Distance between slides in px.', 'cargo-trucking' ) . '<br />' . esc_html__( 'This setting will be applied after save and reload.', 'cargo-trucking' ),
						'type' => Controls_Manager::NUMBER,
						'min' => 0,
						'max' => 100,
						'step' => 1,
		...
		$this->add_control(
			...
			array_merge_recursive(
				$default_args,
				array(
					'label' => esc_html__( 'Autoplay', 'cargo-trucking' ),
					'description' => esc_html__( 'This setting will be applied after save and reload.', 'cargo-trucking' ),
		...
		$this->add_control(
			...
			array_merge_recursive(
				$default_args,
				array(
					'label' => esc_html__( 'Autoplay Speed', 'cargo-trucking' ),
					'description' => esc_html__( 'This setting will be applied after save and reload.', 'cargo-trucking' ),
					'type' => Controls_Manager::NUMBER,
					'min' => 500,
					'default' => $this->get_default_setting(
		...
		$this->add_control(
			...
			array_merge_recursive(
				$default_args,
				array(
					'label' => esc_html__( 'Animation Speed', 'cargo-trucking' ) . ' (ms)',
					'description' => esc_html__( 'This setting will be applied after save and reload.', 'cargo-trucking' ),
					'type' => Controls_Manager::NUMBER,
					'step' => 100,
					'default' => $this->get_default_setting(
		...
		$this->add_control(
			...
			array_merge_recursive(
				$default_args,
				array(
					'label' => esc_html__( 'Pause On Hover', 'cargo-trucking' ),
					'description' => esc_html__( 'This setting will be applied after save and reload.', 'cargo-trucking' ),
					'type' => Controls_Manager::SWITCHER,
					'default' => $this->get_default_setting(
						$this->get_control_name_parameter( $key, 'pause_on_hover' ),
		...
		$this->add_control(
			...
			array_merge_recursive(
				$default_args,
				array(
					'label' => esc_html__( 'Autoplay Reverse', 'cargo-trucking' ),
					'description' => esc_html__( 'This setting will be applied after save and reload.', 'cargo-trucking' ),
					'type' => Controls_Manager::SWITCHER,
					'render_type' => 'none',
		...
		$this->add_control(
			...
			array_merge_recursive(
				$default_args,
				array(
					'label' => esc_html__( 'Infinite Loop', 'cargo-trucking' ),
					'description' => esc_html__( 'This setting will be applied after save and reload.', 'cargo-trucking' ),
					'type' => Controls_Manager::SWITCHER,
					'default' => $this->get_default_setting(
						$this->get_control_name_parameter( $key, 'infinite' ),
		...
		$this->add_control(
			...
			array_merge_recursive(
				$default_args,
				array(
					'label' => esc_html__( 'Mousewheel Control', 'cargo-trucking' ),
					'description' => esc_html__( 'This setting will be applied after save and reload.', 'cargo-trucking' ),
					'type' => Controls_Manager::SWITCHER,
					'default' => $this->get_default_setting(
						$this->get_control_name_parameter( $key, 'mousewheel' ),
		...
		if ( $columns_available ) {
			$this->add_control(
				...
				array_merge_recursive(
					$default_args,
					array(
						'label' => esc_html__( 'Centered Slides', 'cargo-trucking' ),
						'description' => esc_html__( 'Turn on for a slider with an even number of slides only.', 'cargo-trucking' ) . '<br />' . esc_html__( 'This setting will be applied after save and reload.', 'cargo-trucking' ),
						'type' => Controls_Manager::SWITCHER,
						'default' => $this->get_default_setting(
							$this->get_control_name_parameter( $key, 'centered_slides' ),
							'no'
		...
		$this->add_control(
			...
			array_merge_recursive(
				$default_args,
				array(
					'label' => esc_html__( 'Free Mode / No Fixed Positions', 'cargo-trucking' ),
					'description' => esc_html__( 'If enable then slides will not have fixed positions.', 'cargo-trucking' ) . '<br />' . esc_html__( 'This setting will be applied after save and reload.', 'cargo-trucking' ),
					'type' => Controls_Manager::SWITCHER,
					'default' => $this->get_default_setting(
						$this->get_control_name_parameter( $key, 'free_mode' ),
						'no'
		...
		$this->add_control(
			...
			array_merge_recursive(
				$default_args,
				array(
					'label' => esc_html__( 'Arrows', 'cargo-trucking' ),
					'description' => esc_html__( 'This setting will be applied after save and reload.', 'cargo-trucking' ),
					'type' => Controls_Manager::SWITCHER,
		...
		$this->add_control(
			...
			array_merge_recursive(
				$default_args,
				array(
					'label' => esc_html__( 'Navigation', 'cargo-trucking' ),
					'description' => esc_html__( 'This setting will be applied after save and reload.', 'cargo-trucking' ),
					'type' => CmsmastersControls::CHOOSE_TEXT,
					'options' => array(
						'none' => esc_html__( 'None', 'cargo-trucking' ),
						'bullets' => esc_html__( 'Bullets', 'cargo-trucking' ),
						'progressbar' => esc_html__( 'Progress', 'cargo-trucking' ),
						'fraction' => esc_html__( 'Fraction', 'cargo-trucking' ),
					),
					'default' => $this->get_default_setting(
						$this->get_control_name_parameter( $key, 'navigation' ),
						'bullets'
