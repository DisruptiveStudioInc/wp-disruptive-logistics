	...
	protected function controls_group_nav_dropdown_container( $key = '', $args = array() ) {
		...
		$this->add_control(
			...
			array_merge_recursive(
				$default_args,
				array(
					'label' => esc_html__( 'First Dropdown', 'cargo-trucking' ),
		...
		$this->add_control(
			...
			array_merge_recursive(
				...
				array(
					...
					'options' => array(
						'center' => esc_html__( 'Below Item', 'cargo-trucking' ),
						'stretch' => esc_html__( 'Below Header', 'cargo-trucking' ),
					),
					'selectors' => array(
		...
		$this->add_responsive_control(
			...
			array_merge_recursive(
				$default_args,
				array(
					'label' => esc_html__( 'Horizontal Position', 'cargo-trucking' ),
					'type' => Controls_Manager::SLIDER,
					'range' => array(
						'px' => array(
							'min' => -100,
		...
		$this->add_responsive_control(
			...
			array_merge_recursive(
				$default_args,
				array(
					'label' => esc_html__( 'Vertical Gap', 'cargo-trucking' ),
					'type' => Controls_Manager::SLIDER,
					'range' => array(
						'px' => array(
							'min' => -100,
		...
		$this->add_control(
			...
			array_merge_recursive(
				$default_args,
				array(
					'label' => esc_html__( 'Second Dropdown', 'cargo-trucking' ),
					'type' => Controls_Manager::HEADING,
				)
			)
		);
		...
		$this->add_responsive_control(
			...
			array_merge_recursive(
				$default_args,
				array(
					'label' => esc_html__( 'Horizontal Gap', 'cargo-trucking' ),
					'type' => Controls_Manager::SLIDER,
					'range' => array(
						'px' => array(
							'min' => -100,
