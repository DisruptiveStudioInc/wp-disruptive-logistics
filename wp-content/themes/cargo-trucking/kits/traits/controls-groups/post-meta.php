	...
	protected function controls_group_post_meta( $key = '', $args = array() ) {
		...
		$this->add_control(
			...
			array_merge_recursive(
				$default_args,
				array(
					'label' => esc_html__( 'Elements', 'cargo-trucking' ),
					'label_block' => true,
					...
					'options' => array(
						'categories' => esc_html__( 'Categories', 'cargo-trucking' ),
						'author' => esc_html__( 'Author', 'cargo-trucking' ),
						'date' => esc_html__( 'Date', 'cargo-trucking' ),
						'comments' => esc_html__( 'Comments', 'cargo-trucking' ),
						'tags' => esc_html__( 'Tags', 'cargo-trucking' ),
					),
					'multiple' => true,
		...
		$color_controls = array(
			'colors_text' => esc_html__( 'Text', 'cargo-trucking' ),
			'colors_link' => esc_html__( 'Link', 'cargo-trucking' ),
			'colors_hover' => esc_html__( 'Link Hover', 'cargo-trucking' ),
		);
			...
			array_merge_recursive(
				...
				array(
					...
					'options' => array(
						...
						'block' => esc_html__( 'Show', 'cargo-trucking' ),
					),
					'selectors' => array(
