...
define( 'CMSMASTERS_THEME_VERSION', '1.0.2' );

// CMSMasters API
define( 'CMSMASTERS_API_ROUTES_URL', 'http://api.cmsmasters.net/wp-json/cmsmasters-api/v1/' );

// Theme options
define( 'CMSMASTERS_THEME_NAME', 'cargo-trucking' );
define( 'CMSMASTERS_OPTIONS_PREFIX', 'cmsmasters_cargo-trucking_' );
define( 'CMSMASTERS_OPTIONS_NAME', 'cmsmasters_cargo-trucking_options' );
