<?php
namespace CargoTruckingSpace\Woocommerce\CmsmastersFramework;
...
use CargoTruckingSpace\Woocommerce\CmsmastersFramework\Kits\Kit as Plugin_Kit;
...
class Plugin {
	...
	public function __construct() {
		...
		add_action( 'cmsmasters_content_import_start', array( $this, 'before_content_import_setup' ) );

		add_action( 'cmsmasters_content_import_end', array( $this, 'after_content_import_setup' ) );

		add_action( 'cmsmasters_content_import_end', array( $this, 'update_woocommerce_products_after_import' ), 20 );
	...
	public function before_content_import_setup() {
		if ( 'done' === get_option( 'cmsmasters_cargo-trucking_remove_woocommerce_pages' ) ) {
			return;
		}
		...
		update_option( 'cmsmasters_cargo-trucking_remove_woocommerce_pages', 'done', false );
	}
	...
	public function after_content_import_setup() {
		...
		delete_option( 'cmsmasters_cargo-trucking_remove_woocommerce_pages' );
	}
