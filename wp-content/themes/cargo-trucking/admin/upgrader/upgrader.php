<?php
namespace CargoTruckingSpace\Admin\Upgrader;

use CargoTruckingSpace\Admin\Upgrader\Upgrader_Utils;
...
class Upgrader {
	...
	public function __construct() {
		...
		update_option( 'cmsmasters_cargo-trucking_clear_cache', 'pending', false );
	...
	public function run_upgrades() {
		...
		foreach ( Theme_Config::MAJOR_VERSIONS as $major_version ) {
			...
			$class_name = 'CargoTruckingSpace\\ThemeConfig\\UpgraderVersions\\Version_' . str_replace( array( '.', '-' ), '', $major_version );
	...
	public function clear_cache() {
		if (
			'pending' !== get_option( 'cmsmasters_cargo-trucking_clear_cache' ) ||
		...
		add_action( 'elementor/init', function() {
			...
			delete_option( 'cmsmasters_cargo-trucking_clear_cache' );
		} );
	}
