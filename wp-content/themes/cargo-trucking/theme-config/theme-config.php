<?php
namespace CargoTruckingSpace\ThemeConfig;
...
class Theme_Config {
	 ...
	 * Default Colors.
	 */
	const PRIMARY_COLOR_DEFAULT = '#2E3135';
	const SECONDARY_COLOR_DEFAULT = '#282A2C';
	const TEXT_COLOR_DEFAULT = '#3C4449';
	const ACCENT_COLOR_DEFAULT = '#FF5A24';
	const TERTIARY_COLOR_DEFAULT = '#73878B';
	const BACKGROUND_COLOR_DEFAULT = '#F2F2F2';
	const ALTERNATE_COLOR_DEFAULT = '#FFFFFF';
	const BORDER_COLOR_DEFAULT = '#D8D5D2';

	/**
	 * Default Typography.
	 */
	const PRIMARY_TYPOGRAPHY_DEFAULT_FONT_FAMILY = 'Space Grotesk';
	const PRIMARY_TYPOGRAPHY_DEFAULT_FONT_WEIGHT = '500';

	const SECONDARY_TYPOGRAPHY_DEFAULT_FONT_FAMILY = 'Space Grotesk';
	...
	const TAXONOMY_TYPOGRAPHY_DEFAULT_FONT_FAMILY = 'Space Grotesk';
	...
	const TAXONOMY_TYPOGRAPHY_DEFAULT_LINE_HEIGHT = array( 'size' => '1.45', 'unit' => 'em' );
	const TAXONOMY_TYPOGRAPHY_DEFAULT_LETTER_SPACING = array( 'size' => '0', 'unit' => 'px' );
	...
	/* H1 */
	const H1_TYPOGRAPHY_DEFAULT_FONT_FAMILY = 'Space Grotesk';
	...
	const H1_TYPOGRAPHY_DEFAULT_LINE_HEIGHT = array( 'size' => '1.05', 'unit' => 'em' );
	...
	/* H2 */
	const H2_TYPOGRAPHY_DEFAULT_FONT_FAMILY = 'Space Grotesk';
	const H2_TYPOGRAPHY_DEFAULT_FONT_SIZE = array( 'size' => '60', 'unit' => 'px' );
	...
	/* H3 */
	const H3_TYPOGRAPHY_DEFAULT_FONT_FAMILY = 'Space Grotesk';
	const H3_TYPOGRAPHY_DEFAULT_FONT_SIZE = array( 'size' => '46', 'unit' => 'px' );
	...
	const H3_TYPOGRAPHY_DEFAULT_LINE_HEIGHT = array( 'size' => '1.15', 'unit' => 'em' );
	...
	/* H4 */
	const H4_TYPOGRAPHY_DEFAULT_FONT_FAMILY = 'Space Grotesk';
	...
	/* H5 */
	const H5_TYPOGRAPHY_DEFAULT_FONT_FAMILY = 'Space Grotesk';
	const H5_TYPOGRAPHY_DEFAULT_FONT_SIZE = array( 'size' => '22', 'unit' => 'px' );
	...
	const H5_TYPOGRAPHY_DEFAULT_LETTER_SPACING = array( 'size' => '-1', 'unit' => 'px' );
	const H5_TYPOGRAPHY_DEFAULT_WORD_SPACING = array( 'size' => '0', 'unit' => 'px' );

	/* H6 */
	const H6_TYPOGRAPHY_DEFAULT_FONT_FAMILY = 'Space Grotesk';
	...
	const BUTTON_TYPOGRAPHY_DEFAULT_FONT_FAMILY = 'Space Grotesk';
	...
	const BLOCKQUOTE_TYPOGRAPHY_DEFAULT_FONT_FAMILY = 'Space Grotesk';
	...
	public function define_constants() {
		 ...
		 * Product key.
		 */
		define( 'CMSMASTERS_THEME_PRODUCT_KEY', '636172676f2d747275636b696e67' );
	...
	public function enqueue_default_assets() {
		...
		if ( ! did_action( 'elementor/loaded' ) || ! class_exists( 'Cmsmasters_Elementor_Addon' ) ) {
			...
			wp_add_inline_style( 'cargo-trucking-root-style', $default_styles );
		}
	}
