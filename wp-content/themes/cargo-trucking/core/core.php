<?php
namespace CargoTruckingSpace\Core;

use CargoTruckingSpace\Admin\Admin;
use CargoTruckingSpace\Core\Traits\Singleton;
use CargoTruckingSpace\Core\Utils\File_Manager;
use CargoTruckingSpace\Core\Utils\Utils;
use CargoTruckingSpace\Kits\Module as Kits;
use CargoTruckingSpace\Modules\Modules;
use CargoTruckingSpace\TemplateFunctions\General_Elements;
use CargoTruckingSpace\TemplateFunctions\Main_Elements;
use CargoTruckingSpace\ThemeConfig\Theme_Config;
use CargoTruckingSpace\ThemeConfig\Theme_Plugins;
...
class Core {
	...
	public function get_responsive_stylesheet_templates( $templates ) {
		...
		foreach ( $templates_paths as $template_path ) {
			$file_name = 'cargo-trucking-' . basename( $template_path );
	...
	public function enqueue_frontend_assets() {
		...
		wp_localize_script( 'cargo-trucking-frontend', 'cmsmasters_localize_vars', array(
	...
	public function register_widget_areas() {
		...
		register_sidebar(
			array(
				'name' => esc_html__( 'Sidebar', 'cargo-trucking' ),
				'id' => 'sidebar_default',
				'description' => esc_html__( 'Widgets in this area will be shown in all left and right sidebars.', 'cargo-trucking' ),
		...
		register_sidebar(
			array(
				'name' => esc_html__( 'Archive Sidebar', 'cargo-trucking' ),
				'id' => 'sidebar_archive',
				'description' => esc_html__( 'Widgets in this area will be shown in all left and right sidebars on archives pages.', 'cargo-trucking' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget' => '</aside>',
				'before_title' => '<h6 class="widgettitle">',
				'after_title' => '</h6>',
		...
		register_sidebar(
			array(
				'name' => esc_html__( 'Search Sidebar', 'cargo-trucking' ),
				'id' => 'sidebar_search',
				'description' => esc_html__( 'Widgets in this area will be shown in all left and right sidebars on archives pages.', 'cargo-trucking' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget' => '</aside>',
		...
		register_sidebar(
			array(
				'name' => esc_html__( 'Footer 1', 'cargo-trucking' ),
				'id' => 'footer-1',
				'description' => esc_html__( 'Widgets in this area will be shown in footer area.', 'cargo-trucking' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget' => '</aside>',
				'before_title' => '<h6 class="widgettitle">',
				'after_title' => '</h6>',
		...
		register_sidebar(
			array(
				'name' => esc_html__( 'Footer 2', 'cargo-trucking' ),
				'id' => 'footer-2',
				'description' => esc_html__( 'Widgets in this area will be shown in footer area.', 'cargo-trucking' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget' => '</aside>',
		...
		register_sidebar(
			array(
				'name' => esc_html__( 'Footer 3', 'cargo-trucking' ),
				'id' => 'footer-3',
				'description' => esc_html__( 'Widgets in this area will be shown in footer area.', 'cargo-trucking' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget' => '</aside>',
		...
		register_sidebar(
			array(
				'name' => esc_html__( 'Footer 4', 'cargo-trucking' ),
				'id' => 'footer-4',
				'description' => esc_html__( 'Widgets in this area will be shown in footer area.', 'cargo-trucking' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget' => '</aside>',
		...
		register_sidebar(
			array(
				'name' => esc_html__( 'Footer 5', 'cargo-trucking' ),
				'id' => 'footer-5',
				'description' => esc_html__( 'Widgets in this area will be shown in footer area.', 'cargo-trucking' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget' => '</aside>',
	...
	public function register_translations() {
		load_theme_textdomain( 'cargo-trucking', get_template_directory() . '/theme-config/languages' );
	}
	...
	public function register_nav_menu_locations() {
		register_nav_menus(
			array(
				'header_top_nav' => esc_html__( 'Header Top Navigation', 'cargo-trucking' ),
				'header_mid_nav' => esc_html__( 'Header Middle Navigation', 'cargo-trucking' ),
				'header_bot_nav' => esc_html__( 'Header Bottom Navigation', 'cargo-trucking' ),
				'footer_nav' => esc_html__( 'Footer Navigation', 'cargo-trucking' ),
			)
		);
	}
	...
	public function filter_password_form() {
		$output = '<p>' . esc_html__( 'This content is password protected. To view it please enter your password below:', 'cargo-trucking' ) . '</p>' .
		'<form action="' . esc_url( site_url( 'wp-login.php?action=postpass', 'login_post' ) ) . '" class="post-password-form cmsmasters-post-password-form" method="post">' .
			'<input name="post_password" type="password" size="20" placeholder="' . esc_attr__( 'Password', 'cargo-trucking' ) . '" />' .
			'<input type="submit" name="Submit" value="' . esc_attr_x( 'Enter', 'post password form', 'cargo-trucking' ) . '" />' .
		'</form>';
