<?php
namespace CargoTruckingSpace\Core\Utils;
...
class File_Manager {
	...
	public static function get_css_template_assets_url( $file_name, $relative_url = null, $add_min_suffix = 'default', $add_direction_suffix = false, $path_prefix = '' ) {
		if ( Utils::has_custom_breakpoints() ) {
			...
			$responsive_file = new ElementorResponsiveFilesFrontend( "cargo-trucking-{$file}", self::get_responsive_css_path( $path_prefix ) . $file );
